...
var DialogContentInnerComponent = function (_a) {
    ...
    return (React.createElement(Wrapper, { className: isMounted ? 'active' : '' },
        React.createElement(Background, __assign({ onClick: onClickOverlay }, props)),
        React.createElement(Inner, __assign({}, props), children),
        React.createElement(ScrollSuppressing, null)));
};
export var DialogContentInner = withTheme(DialogContentInnerComponent);
