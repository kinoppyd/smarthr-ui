...
export var DialogContent = function (_a) {
    ...
    var _b = useContext(DialogContext), DialogContentRoot = _b.DialogContentRoot, onClickClose = _b.onClickClose;
    return (React.createElement(DialogContentRoot, null,
        React.createElement(DialogContentContext.Provider, { value: { onClickClose: onClickClose } },
            React.createElement(DialogContentInner, __assign({ onClickOverlay: onClickClose }, props), children))));
};
