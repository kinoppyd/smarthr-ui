...
exports.toggleContentView = function (className, additionalClassName) { return function (active, triggerRect, children, onClickCloser) { return function () {
    if (active) {
        ...
        react_dom_1.render(react_1.default.createElement(exports.DropdownContentContext.Provider, { value: { onClickCloser: onClickCloser } },
...
exports.DropdownContent = function (_a) {
    ...
    react_1.useEffect(exports.toggleContentView("dropdown-content-" + key)(active, triggerRect, children, onClickCloser), [active, children, key, onClickCloser]);
    return null;
};
