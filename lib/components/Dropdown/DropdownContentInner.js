...
var DropdownContentInnerComponent = function (_a) {
    ...
    react_1.useEffect(function () {
        if (isMounted && wrapperRef.current) {
            var contentPosition = dropdownHelper_1.getContentPositionStyle(triggerRect, {
    ...
    return (react_1.default.createElement(Wrapper, { ref: wrapperRef, position: position, className: isMounted ? 'active' : '', theme: theme }, children));
};
