...
var Button = styled_components_1.default.button(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  ", "\n  ", "\n"], ["\n  ", "\n  ",
    ...
    return styled_components_1.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      display: flex;\n      align-items: center;\n      width: 100%;\n      height: 40px;\n      padding: 0 ", ";\n      color: ", ";\n      font-size: ", ";\n      text-align: left;\n      cursor: pointer;\n      transition: ", ";\n\n      &:hover {\n        background-color: ", ";\n      }\n      &.right {\n        justify-content: space-between;\n      }\n      &.left {\n        justify-content: left;\n      }\n    "], ["\n      display: flex;\n      align-items: center;\n      width: 100%;\n      height: 40px;\n      padding: 0 ", ";\n      color: ", ";\n      font-size: ", ";\n      text-align: left;\n      cursor: pointer;\n      transition: ", ";\n\n      &:hover {\n        background-color: ", ";\n      }\n      &.right {\n        justify-content: space-between;\n      }\n      &.left {\n        justify-content: left;\n      }\n    "])), size.pxToRem(size.space.XS), palette.TEXT_BLACK, size.pxToRem(size.font.TALL), ua_1.isTouchDevice ? 'none' : "all " + interaction.hover.animation, palette.hoverColor('#fff'));
});
