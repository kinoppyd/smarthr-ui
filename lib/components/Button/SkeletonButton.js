...
exports.SkeletonButton = withTheme_1.withTheme(injectStyle(BaseButton_1.BaseButton));
exports.SkeletonButtonAnchor = withTheme_1.withTheme(injectStyle(BaseButton_1.BaseButtonAnchor));
