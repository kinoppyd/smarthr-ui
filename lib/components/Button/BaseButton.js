...
var Base = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    ...
    }, frame.border.radius.m, ua_1.isTouchDevice ? 'none' : "all " + interaction.hover.animation, size.pxToRem(size.font.TALL), size.pxToRem(size.space.XS), size.pxToRem(size.font.SHORT), size.pxToRem(size.space.XXS));
});
